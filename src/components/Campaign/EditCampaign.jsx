...
export default function EditCampaign(props) {
    ...
    useEffect(() => {
        fetchCampaignData().then(res => {
            let campaign    = res.data,
                emails      = campaign.emails.length > 0 ? campaign.emails : [{...defaultEmailData}];
            setEmailData(emails);
    ...
    const updateCampaign = async () => {
        ...
        setResponseMessage('Campaign is updated successfully.')
    };
                        ...
                        <div className="email-container">
                            ...
                            <div className="email-subject input-item">
                                ...
                                <input
                                    ...
                                    onChange={e => handleEmailFieldsChange(e.target.value, 'email_subject')}
                                    placeholder="Be Specific and concise to spark interest"
                                />
                                <span>{emailData[selectedEmailIndex]?.email_subject.length}/200</span>
                            ...
                            <div className="email-preview input-item">
                                ...
                                <input
                                    ...
                                    onChange={e => handleEmailFieldsChange(e.target.value, 'email_preview_text')}
                            ...
                            <div className="email-from input-item">
                                ...
                                <input
                                    ...
                                    onChange={e => handleEmailFieldsChange(e.target.value, 'sender_name')}
                                ...
                                <input
                                    ...
                                    onChange={e => handleEmailFieldsChange(e.target.value, 'sender_email')}
