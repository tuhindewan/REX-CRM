                    ...
                    <div className="condition-matching">
                        ...
                        >
                            ...
                            <ul className="mintmrm-dropdown mrm-custom-select-dropdown">
                                <li onClick={handleSelectMatch} value="all">
                                    All
                                </li>
                                <li onClick={handleSelectMatch} value="any">
                                    Any
                                </li>
                            </ul>
                        </div>
