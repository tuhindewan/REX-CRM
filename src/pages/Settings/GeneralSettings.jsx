        ...
        getGeneralSettings().then((response) => {
            if (response.success) {
                ...
                if (Object.keys(unsubscriber_settings).length > 0) {
                    ...
                    setSelectPageOption(unsubscriber_settings.page_title)
                    // setConfirmation_message(
                    //     unsubscriber_settings.confirmation_message
                    // );
                    // tinymce.get("confirmation-message").setContent(unsubscriber_settings.confirmation_message);
                }
        ...
        getGeneralSettings().then((response) => {
            if (Object.keys(response.unsubscriber_settings).length > 0) {
                tinymce
                    ...
                    .setContent(
                        response.unsubscriber_settings.confirmation_message
                    );
            }
        });
                                    ...
                                    <div className="tab-body">
                                        ...
                                        <div className="form-wrapper">
                                            ...
                                            <div className="general-single-settings">
                                                ...
                                                >
                                                    <div
                                                        className="form-group label-block"
