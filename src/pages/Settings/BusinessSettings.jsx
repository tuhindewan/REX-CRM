              ...
              <div className="single-tab-content business-tab-content">
                <div className="tab-body">
                  ...
                  <div
                    className={
                      tabState === 1
                        ? "form-wrapper business-settings-wrapper active"
                        : "form-wrapper business-settings-wrapper"
                    }
                  >
                  ...
                  <div
                    className={
                      tabState === 2
                        ? "form-wrapper social-settings-wrapper active"
                        : "form-wrapper social-settings-wrapper"
                    }
                  >
                ...
                <div className="tab-footer">
                  ...
                  >
                    Save Settings
                    {saveLoader && <span className="mintmrm-loader"></span>}
                  </button>
                </div>
              </div>
            </div>
