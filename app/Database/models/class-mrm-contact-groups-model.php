...
use Mint\MRM\DataBase\Tables\ContactGroup;
...
class MRM_Contact_Group_Model{
    ...
    public static function get_all( $type, $offset = 0, $limit = 20, $search = '' )
    {
        ...
        try {
            $select_query  = "SELECT * FROM $group_table WHERE type = '$type' $search_terms ORDER BY id DESC LIMIT $offset, $limit";
    ...
    public static function destroy_all( $ids )
    {
        ...
        $group_table  = $wpdb->prefix . ContactGroup::$table_name;
        $pivot_table  = $wpdb->prefix . ContactGroupPivotSchema::$table_name;
