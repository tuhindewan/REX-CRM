...
use Mint\MRM\DataBase\Tables\InteractionSchema;
...
class MRM_Contact_Model{
    ...
    public static function destroy( $id )
    {
        ...
        $contact_interaction_table      =   $wpdb->prefix . InteractionSchema::$table_name;
     ...
     * @since 1.0.0
     */
    public static function get_filtered_contacts( $status, $group_ids, $limit = 10, $offset = 0, $search = '' )
    {
        global $wpdb;
        $contact_table = $wpdb->prefix . ContactSchema::$table_name;
