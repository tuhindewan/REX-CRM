...
function Sidebar() {
  ...
  useEffect(() => {
    ...
    if (prevSetting !== null && prevSetting !== void 0 && (_prevSetting$settings19 = prevSetting.settings) !== null && _prevSetting$settings19 !== void 0 && (_prevSetting$settings20 = _prevSetting$settings19.confirmation_type) !== null && _prevSetting$settings20 !== void 0 && (_prevSetting$settings21 = _prevSetting$settings20.to_a_page) !== null && _prevSetting$settings21 !== void 0 && _prevSetting$settings21.redirection_message) {
      ...
      setRedirectionMessage(prevSetting === null || prevSetting === void 0 ? void 0 : (_prevSetting$settings22 = prevSetting.settings) === null || _prevSetting$settings22 === void 0 ? void 0 : (_prevSetting$settings23 = _prevSetting$settings22.confirmation_type) === null || _prevSetting$settings23 === void 0 ? void 0 : (_prevSetting$settings24 = _prevSetting$settings23.to_a_page) === null || _prevSetting$settings24 === void 0 ? void 0 : _prevSetting$settings24.redirection_message);
    } else {
      setRedirectionMessage("Welcome to this page. Form Submitted Successfully!");
    }

    // set custom url for "to a custom url" tab
    if (prevSetting !== null && prevSetting !== void 0 && (_prevSetting$settings25 = prevSetting.settings) !== null && _prevSetting$settings25 !== void 0 && (_prevSetting$settings26 = _prevSetting$settings25.confirmation_type) !== null && _prevSetting$settings26 !== void 0 && (_prevSetting$settings27 = _prevSetting$settings26.to_a_custom_url) !== null && _prevSetting$settings27 !== void 0 && _prevSetting$settings27.custom_url) {
      var _prevSetting$settings28, _prevSetting$settings29, _prevSetting$settings30, _prevSetting$settings31, _prevSetting$settings32, _prevSetting$settings33;
      setCustomURL(prevSetting === null || prevSetting === void 0 ? void 0 : (_prevSetting$settings28 = prevSetting.settings) === null || _prevSetting$settings28 === void 0 ? void 0 : (_prevSetting$settings29 = _prevSetting$settings28.confirmation_type) === null || _prevSetting$settings29 === void 0 ? void 0 : (_prevSetting$settings30 = _prevSetting$settings29.to_a_custom_url) === null || _prevSetting$settings30 === void 0 ? void 0 : _prevSetting$settings30.custom_url);
      setIsValidUrl(validURL(prevSetting === null || prevSetting === void 0 ? void 0 : (_prevSetting$settings31 = prevSetting.settings) === null || _prevSetting$settings31 === void 0 ? void 0 : (_prevSetting$settings32 = _prevSetting$settings31.confirmation_type) === null || _prevSetting$settings32 === void 0 ? void 0 : (_prevSetting$settings33 = _prevSetting$settings32.to_a_custom_url) === null || _prevSetting$settings33 === void 0 ? void 0 : _prevSetting$settings33.custom_url));
    } else {
      setCustomURL("https://");
    }

    // set message for a "to a custom url" tab
    if (prevSetting !== null && prevSetting !== void 0 && (_prevSetting$settings34 = prevSetting.settings) !== null && _prevSetting$settings34 !== void 0 && (_prevSetting$settings35 = _prevSetting$settings34.confirmation_type) !== null && _prevSetting$settings35 !== void 0 && (_prevSetting$settings36 = _prevSetting$settings35.to_a_custom_url) !== null && _prevSetting$settings36 !== void 0 && _prevSetting$settings36.custom_redirection_message) {
      var _prevSetting$settings37, _prevSetting$settings38, _prevSetting$settings39;
      setCustomRedirectionMessage(prevSetting === null || prevSetting === void 0 ? void 0 : (_prevSetting$settings37 = prevSetting.settings) === null || _prevSetting$settings37 === void 0 ? void 0 : (_prevSetting$settings38 = _prevSetting$settings37.confirmation_type) === null || _prevSetting$settings38 === void 0 ? void 0 : (_prevSetting$settings39 = _prevSetting$settings38.to_a_custom_url) === null || _prevSetting$settings39 === void 0 ? void 0 : _prevSetting$settings39.custom_redirection_message);
    } else {
      setCustomRedirectionMessage("You are redirected to a new url.");
    }

    // set form layout position
    if (prevSetting !== null && prevSetting !== void 0 && (_prevSetting$settings40 = prevSetting.settings) !== null && _prevSetting$settings40 !== void 0 && (_prevSetting$settings41 = _prevSetting$settings40.form_layout) !== null && _prevSetting$settings41 !== void 0 && _prevSetting$settings41.form_position) {
      var _prevSetting$settings42, _prevSetting$settings43;
      setFormPosition(prevSetting === null || prevSetting === void 0 ? void 0 : (_prevSetting$settings42 = prevSetting.settings) === null || _prevSetting$settings42 === void 0 ? void 0 : (_prevSetting$settings43 = _prevSetting$settings42.form_layout) === null || _prevSetting$settings43 === void 0 ? void 0 : _prevSetting$settings43.form_position);
    } else {
      setFormPosition("default");
    }

    //set form layout animation
    if (prevSetting !== null && prevSetting !== void 0 && (_prevSetting$settings44 = prevSetting.settings) !== null && _prevSetting$settings44 !== void 0 && (_prevSetting$settings45 = _prevSetting$settings44.form_layout) !== null && _prevSetting$settings45 !== void 0 && _prevSetting$settings45.form_animation) {
      var _prevSetting$settings46, _prevSetting$settings47;
      setFormPosition(prevSetting === null || prevSetting === void 0 ? void 0 : (_prevSetting$settings46 = prevSetting.settings) === null || _prevSetting$settings46 === void 0 ? void 0 : (_prevSetting$settings47 = _prevSetting$settings46.form_layout) === null || _prevSetting$settings47 === void 0 ? void 0 : _prevSetting$settings47.form_animation);
    } else {
      setFormPosition("default");
    }
  }, [prevSetting]);
  ...
  }, [messageToShow, afterFormSubmission, selectedPageId, redirectionMessage, customURL, customRedirectionMessage, formPosition, formAnimation, formScheduling, submissionStartDate, submissionStartTime, maxEntries, count, maxType]);
  useEffect(() => {
