"use strict";
(self["webpackChunkformbuilder"] = self["webpackChunkformbuilder"] || []).push([["packages_easy-email-extensions_lib_index3_js"],{

/***/ "../../../packages/easy-email-extensions/lib/index3.js":
/*!*************************************************************!*\
  !*** ../../../packages/easy-email-extensions/lib/index3.js ***!
  \*************************************************************/
...
/* harmony export */   "default": function() { return /* binding */ CodemirrorEditor; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _index2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index2.js */ "../../../packages/easy-email-extensions/lib/index2.js");
/* harmony import */ var easy_email_editor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! easy-email-editor */ "../../../packages/easy-email-editor/lib/index.js");
/* harmony import */ var easy_email_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! easy-email-core */ "../../../packages/easy-email-core/lib/index.es.js");
...
(function (module, exports) {
  (function (global, factory) {
  ...
  })(_index2_js__WEBPACK_IMPORTED_MODULE_1__.c, function () {
    ...
    function highlightLine(cm2, line, context, forceToEnd) {
      ...
      var loop = function (o2) {
        ...
        var overlay = cm2.state.overlays[o2],
            i2 = 1,
            at = 0;
        context.state = true;
    ...
    function takeToken(cm2, pos, precise, asArray) {
      ...
      var line = getLine(doc, pos.line),
          context = getContextBefore(cm2, pos.line, precise);
      var stream = new StringStream(line.text, cm2.options.tabSize, context),
          tokens;
      ...
      if (cm2.options.lineNumbers || markers) {
        ...
        if (markers) {
          for (var k = 0; k < cm2.display.gutterSpecs.length; ++k) {
            var id = cm2.display.gutterSpecs[k].className,
    ...
    function measureCharInner(cm2, prepared, ch, bias) {
      ...
      if (ie && ie_version < 9 && !start && (!rect || !rect.left && !rect.right)) {
        ...
        if (rSpan) {
          rect = {
            left: rSpan.left,
            right: rSpan.left + charWidth(cm2.display),
            top: rSpan.top,
            bottom: rSpan.bottom
          };
        } else {
    ...
    function estimateHeight(cm2) {
      var th = textHeight(cm2.display),
          wrapping = cm2.options.lineWrapping;
    ...
    function regLineChange(cm2, line, type) {
      cm2.curOp.viewChanged = true;
      var display = cm2.display,
          ext = cm2.display.externalMeasured;
    ...
    function viewCuttingPoint(cm2, oldN, newN, dir) {
      var index = findViewIndex(cm2, oldN),
          diff,
          view = cm2.display.view;
    ...
    function drawSelectionRange(cm2, range2, output) {
      ...
      var padding = paddingH(cm2.display),
    ...
    function scrollPosIntoView(cm2, pos, end, margin) {
      ...
      for (var limit = 0; limit < 5; limit++) {
        ...
        var startTop = cm2.doc.scrollTop,
            startLeft = cm2.doc.scrollLeft;
    ...
    function calculateScrollPos(cm2, rect) {
      var display = cm2.display,
          snapMargin = textHeight(cm2.display);
    ...
    function ensureCursorVisible(cm2) {
      ...
      cm2.curOp.scrollToPos = {
        from: cur,
        to: cur,
        margin: cm2.options.cursorScrollMargin
      };
    }
    ...
    function resolveScrollToPos(cm2) {
      ...
      if (range2) {
        ...
        var from = estimateCoords(cm2, range2.from),
            to = estimateCoords(cm2, range2.to);
    ...
    function updateScrollbars(cm2, measure) {
      ...
      var startWidth = cm2.display.barWidth,
    ...
    function endOperation_R1(op) {
      ...
      op.update = op.mustUpdate && new DisplayUpdate(cm2, op.mustUpdate && {
        top: op.scrollTop,
      ...
      for (var first = true;; first = false) {
        if (!first || !cm2.options.lineWrapping || update.oldDisplayWidth == displayWidth(cm2)) {
          if (viewport && viewport.top != null) {
            viewport = {
              top: Math.min(cm2.doc.height + paddingVert(cm2.display) - displayHeight(cm2), viewport.top)
            };
          }
    ...
    function patchDisplay(cm2, updateNumbersFrom, dims) {
      var display = cm2.display,
          lineNumbers = cm2.options.lineNumbers;
      var container2 = display.lineDiv,
          cur = container2.firstChild;
      ...
      for (var i2 = 0; i2 < view.length; i2++) {
        var lineView = view[i2];
        if (lineView.hidden) ;else if (!lineView.node || lineView.node.parentNode != container2) {
    ...
    function maybeUpdateLineNumberWidth(cm2) {
      ...
      var doc = cm2.doc,
          last = lineNumberFor(cm2.options, doc.first + doc.size - 1),
          display = cm2.display;
    ...
    function makeChangeSingleDocInEditor(cm2, change, spans) {
      ...
      var changesHandler = hasHandler(cm2, "changes"),
          changeHandler = hasHandler(cm2, "change");
    ...
    function onDrop(e) {
      ...
      var pos = posFromMouse(cm2, e, true),
    ...
    var commands = {
      ...
      delWrappedLineRight: function (cm2) {
        return deleteNearSelection(cm2, function (range2) {
          var top = cm2.charCoords(range2.head, "div").top + 5;
          var rightPos = cm2.coordsChar({
            left: cm2.display.lineDiv.offsetWidth + 100,
            top
          }, "div");
          return {
            from: range2.from(),
      ...
      insertSoftTab: function (cm2) {
        var spaces = [],
            ranges = cm2.listSelections(),
            tabSize = cm2.options.tabSize;
        ...
        return runInOp(cm2, function () {
          ...
          for (var i2 = 0; i2 < ranges.length; i2++) {
            ...
            var cur = ranges[i2].head,
                line = getLine(cm2.doc, cur.line).text;
    ...
    function doHandleBinding(cm2, bound, dropShift) {
      ...
      var prevShift = cm2.display.shift,
          done = false;
    ...
    function leftButtonSelect(cm2, event, start, behavior) {
      ...
      if (!behavior.addNew) {
        ...
        setSelection(doc, normalizeSelection(cm2, ranges.concat([ourRange]), ourIndex), {
          scroll: false,
          origin: "*mouse"
        });
      } else if (ranges.length > 1 && ranges[ourIndex].empty() && behavior.unit == "char" && !behavior.extend) {
        setSelection(doc, normalizeSelection(cm2, ranges.slice(0, ourIndex).concat(ranges.slice(ourIndex + 1)), 0), {
          scroll: false,
          origin: "*mouse"
        });
        startSel = doc.sel;
      ...
      function extendTo(pos) {
        ...
        if (behavior.unit == "rectangle") {
          ...
          setSelection(doc, normalizeSelection(cm2, startSel.ranges.slice(0, ourIndex).concat(ranges2), ourIndex), {
            origin: "*mouse",
            scroll: false
          });
    ...
    function registerEventHandlers(cm2) {
      ...
      on(d.scroller, "touchend", function (e) {
        ...
        if (touch && !eventInWidget(d, e) && touch.left != null && !touch.moved && new Date() - touch.start < 300) {
          var pos = cm2.coordsChar(d.activeTouch, "page"),
              range2;
    ...
    ContentEditableInput.prototype.showPrimarySelection = function () {
      ...
      var view = cm2.display.view;
      var start = from.line >= cm2.display.viewFrom && posToDOM(cm2, from) || {
    ...
    TextareaInput.prototype.init = function (display) {
      ...
      on(te, "compositionstart", function () {
        ...
        input.composing = {
          start,
          range: cm2.markText(start, cm2.getCursor("to"), {
    ...
    TextareaInput.prototype.poll = function () {
      ...
      runInOp(cm2, function () {
        ...
        if (this$1$1.composing) {
          ...
          this$1$1.composing.range = cm2.markText(this$1$1.composing.start, cm2.getCursor("to"), {
            className: "CodeMirror-composing"
          });
        }
      });
...
var SERVER_RENDERED = typeof navigator === "undefined" || _index2_js__WEBPACK_IMPORTED_MODULE_1__.c.PREVENT_CODEMIRROR_RENDER === true;
var cm;
...
function CodemirrorEditor(props) {
  ...
  return /* @__PURE__ */react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Controlled_1, {
...
//# sourceMappingURL=packages_easy-email-extensions_lib_index3_js.js.map