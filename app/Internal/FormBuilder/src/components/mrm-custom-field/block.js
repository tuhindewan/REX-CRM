...
const mrmCustomField = ({
    ...
    return (
        <>
            <div className="mrm mrm-gutenberg-form-wrapper">
                <div className="mrm-form-wrapper" >
                    ...
                    {field_type == 'textarea' &&
                        <div className="mrm-input-group" style={fieldSpacing}>
                    ...
                    {field_type == 'date' &&
                        <div className="mrm-form-group date" style={fieldSpacing}>
                            <label htmlFor="mrm-date" style={labelStyle} >
                                {field_label ? __(field_label, 'mrm') : ''}
                                {field_require && <span className="required-mark">*</span>}
                            </label>
                            <div>
                    ...
                    {field_type == 'radio' &&
                        <div className="mrm-form-group radio">
                            <div key={`mrm-${field_label}`} className="mrm-radio-group">
                    ...
                    {field_type == 'select' &&
                    <div className="mrm-form-group select">
                        <div key={`mrm-${field_label}`} className="mrm-input-group" style={fieldSpacing}>
                            <label htmlFor={field_slug} style={labelStyle}>
                                {field_label ? __(field_label,'mrm') : __('','mrm')}
                                {field_require && <span className="required-mark">*</span>}
                            </label>
