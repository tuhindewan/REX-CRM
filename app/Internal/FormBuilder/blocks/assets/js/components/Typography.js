...
class Typography extends Component {
	...
	handleClickOutside = (event) => {
		...
		if (showFontFamiles) {
			...
			const mrmTypographySelectedFontFamily = this.refs.mrmTypographySelectedFontFamily
								...
								<Fragment>
									...
									<div className="mrmTypography-field-group mrmTypography-65-35">
										<div className="mrmTypography-field mrmTypography-field-font-family">
											...
											<div className="mrmTypography-font-family-picker" ref="mrmTypographySelectedFontFamily"
												 onClick={() => {
														...
														newFontList.map((font, index) => {
															...
															return (
																<div className={fontClasses}
																	 id={`mrmTypography-font-family-${index}`}
																	 onClick={() => {
