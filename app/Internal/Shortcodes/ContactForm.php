...
class ContactForm {
	...
	public function get_content() {
		...
		if ( $show ) {
			ob_start();?>
			<div class="mintmrm" >
				<div id="mrm-<?php echo $form_placement; ?>" class="mrm-form-wrapper mrm-<?php echo $form_animation; ?> <?php
				echo isset( $this->attributes['class'] ) ? $this->attributes['class'] : '';
				echo 'mrm-' . $form_placement;
				?>
				">
